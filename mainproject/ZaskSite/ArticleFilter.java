...
public class ArticleFilter {
	...
	public static void sort_all() {
		try {
			...
			String date = driver_inst.selector("//*[@id=\"zask-solutions-pagination\"]/zask-ui-solution-summaries/div/zask-ui-solution-summary-view[1]/zask-ui-card/div/div[2]/div/div/div/span[2]").getText(); 
			Assert.assertEquals(date,"Sep 21 `21 @ 12:42"); 
			System.out.println("Current date updated: --Pass--"); 
		} catch(AssertionError e) { 
			System.out.println("Current date not updated --Fail--"); 
		}
	}
	...
	public static void My_article_Filter_btn() throws InterruptedException {	
		...
		try {
			driver_inst.Click_evt("//*[text()='ADD ARTICLE']");
