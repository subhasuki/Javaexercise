...
public class AskEdit {	
	...
	public static void Login() throws InterruptedException {
		try {	
			driver_inst.send_Val("#login_id", "xxxxxxx@.com");
	...
	public static void likebtn() throws InterruptedException{ 	
		...
		if(Actual_like_class.equals("up info-ico icon like vote likeClicked")) {
			...
			Assert.assertEquals("2",score_txt);
	...
	public static void dislike() throws InterruptedException {					
		...
		try {	
			Assert.assertEquals("down info-ico icon dislike vote dislikeClicked",Actual_dislike_class);
			System.out.println("Like Button class changed:--Pass-- \n");
		} catch(Exception e) {
			System.out.println("Like Button class not changed:--Fail-- \n");
		}	
		...
		try {			
			...
			Assert.assertEquals("down info-ico icon dislike vote",Actual_remove_dislike_class);
		...
		try {			
			String vote_dislike_select = driver_inst.selector("span.count").getText();
			//			vote_dislike_select.getAttribute("vote_value");
			System.out.println("DISLIKE VOTE VALUE........."+vote_dislike_select);
			//			String Actual_remove_vote_ = vote_dislike_select.getAttribute("class");
			System.out.println("IF before class........."+vote_dislike_select);
			Assert.assertEquals("1",vote_dislike_select);
	...
	public static void favourite() {		
		try {			
			...
			System.out.println(favourite_class);
			Assert.assertEquals("info-ico icon favouriteClicked",favourite_class);
			System.out.println("Favourite icon click class check:--Pass-- \n");
		} catch(Exception e) {
			System.out.println("Favourite icon click class check:--Fail-- \n");
		} 
		try {
			driver_inst.navigate();
			...
			driver_inst.Click_evt(".filter-button");
			System.out.println("Dislike Button class changed:--Pass-- \n");
		} catch(Exception e) {
			System.out.println("Dislike Button class not changed:--Fail-- \n");
		} 
		try {
			driver_inst.Click_evt("p.question-title");
			driver_inst.Click_evt(".fav > span").getText();
			driver_inst.Click_evt("//span[text()='Favourite']");
			driver_inst.Click_evt(".filter-button");
			System.out.println("Dislike Button class changed:--Pass-- \n");
		} catch(Exception e) {
	...
	public static void Edit_page() {
		//		driver_inst.Click_evt("//like-to[@header-route-id='Questions']");
